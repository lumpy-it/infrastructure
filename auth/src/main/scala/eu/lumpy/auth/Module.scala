...
import eu.lumpy.auth.http.{HttpErrorHandler, UserHttpEndpoint}
import eu.lumpy.auth.repository.PostgresUserRepository
import eu.lumpy.auth.repository.algebra.UserRepository
import eu.lumpy.auth.service.UserService
